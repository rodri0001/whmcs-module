...
class rodriInfo extends AbstractWidget
{
    ...
    {
    $waiting = Capsule::table('mod_rodridomain')->where('laststatus', '0')->orderby('updated_at', 'desc')->get();
    ...
    public function generateOutput($data)
    {
     ...
     ';
        ...
        return <<<EOF
<style>
.widget-rodriinfo .item:nth-child(2n) {
    background-color: 
    #f8f8f8;
}
.widget-rodriinfo .rodriinfo-list {
    margin: 0 20px 20px 20px;
    font-size: .9em;
    max-height: 240px;
    overflow: auto;
}
.widget-rodriinfo .description {
    display: block;
    font-style: italic;
    color: 
    #63cfd2;
...
.widget-rodriinfo .item {
    padding: 5px 8px;
    white-space: nowrap;
    overflow: hidden;
    text-overflow: ellipsis;
}
.widget-rodriinfo .last-activity {
	float: right;
	color: #959595;
	font-size: .9em;
}
